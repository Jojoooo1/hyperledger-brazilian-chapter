 ...
 * @hidden
 */
var MockStateQueryIterator = /** @class */ (function () {
    function MockStateQueryIterator(data, txID) {
        this.data = data;
        this.txID = txID;
        this.currentLoc = 0;
        this.closed = false;
    }
    Object.defineProperty(MockStateQueryIterator.prototype, "response", {
        get: function () {
            return {
                results: this.data,
    ...
    MockStateQueryIterator.prototype.next = function () {
        if (this.closed) {
